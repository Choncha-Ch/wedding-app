...
import { hasSeenEntrance, markEntranceSeen } from '@/lib/storage';
...
const Index = () => {
  ...
  return (
    <>
      {showEntrance && <EnvelopeEntrance onComplete={handleEntranceComplete} />}
      ...
      <div className="min-h-screen bg-cream pb-20">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, delay: showEntrance ? 2.5 : 0.2 }}
        >
